...
public class Main extends JFrame {
    ...
    static Mesh genTerrain(float xmin, float xmax, float zmin, float zmax, float ystart, float yrange, float noise, float roughness_factor, int density) {
    	int map_size = 1;
    ...
    // Performs one iteration of the square step and then diamond step for height map terrain generation
    ...
    // Signed volume of a tetrahedron (used for collision detection). True if positive, false otherwise.
